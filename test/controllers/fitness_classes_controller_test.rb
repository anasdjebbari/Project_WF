...
class FitnessClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fitness_class" do
    assert_difference('FitnessClass.count') do
      post fitness_classes_url, params: { fitness_class: { description: @fitness_class.description, end_time: @fitness_class.end_time, start_time: @fitness_class.start_time, title: @fitness_class.title } }
    end
  ...
  test "should update fitness_class" do
    patch fitness_class_url(@fitness_class), params: { fitness_class: { description: @fitness_class.description, end_time: @fitness_class.end_time, start_time: @fitness_class.start_time, title: @fitness_class.title } }
